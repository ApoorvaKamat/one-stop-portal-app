export const news =[
    ...
    {
        id:4,
        description: 'Change in the company Healthcare policies. Click to read more',
        imageSrc: '/healthcare.jpg',
    },
    {
        id:5,
        description: 'OneStopGraphica Recognized as a Leader in IDC MarketScape Worldwide Managed Cloud Security Services. Click to read more',
        imageSrc: '/cloud.jpg',
    },
    {
        id:6,
